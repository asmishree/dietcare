...
function SignUp() {
  return (
    ...
    <div className="w-full max-w-xl mx-auto lg:w-96">
        <div>
            <h2 className="mt-6 text-3xl font-extrabold text-neutral-600">SignUp.</h2>
        </div>
        ...
        <div className="mt-8">
            <div className="mt-6">
                ...
                <div>
                        <label for="name" className="block text-sm font-medium text-neutral-600"> Full Name </label>
                        <div className="mt-1">
                    ...
                    <div>
                        <button type="submit" className="flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-blue-600 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Signup</button>
                    </div>
                </form>
                ...
                <div>
                    ...
                    <div className="flex my-5 justify-center font-semibold">Already have an account?<Link to={"/login"} className="mx-2 text-blue-600 cursor-pointer">Login</Link></div>
                </div>
            </div>
        </div>
    </div>
